---
title: 'Deploy TanStack Start on AWS with Thunder - Step-by-Step Guide'
...
TanStack Start applications are deployed using the `Fargate` construct, which provides full-stack SSR capabilities with managed containerization.
