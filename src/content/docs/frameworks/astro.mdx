...
Deploy your static [Astro](https://astro.build/) SPA to AWS with S3 and CloudFront for fast, reliable performance. This guide walks you through configuration and setup to get your site live.
