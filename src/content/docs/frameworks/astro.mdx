...
Deploy your [Astro](https://astro.build/) static SPA to AWS with S3 and CloudFront for fast, reliable performance. This guide walks you through configuration and setup to get your site live.
...
| Build Command             | `yarn astro check && yarn astro build`      |
| Output Directory          | `dist`           |
  </TabItem>
