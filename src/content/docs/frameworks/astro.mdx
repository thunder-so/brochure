...
2. **Serverless SSR** — Deploy SSR Astro applications using Lambda, S3, and CloudFront with the `Astro` construct
3. **Containerized SSR** — Deploy SSR Astro applications using ECS Fargate with the `Fargate` construct
