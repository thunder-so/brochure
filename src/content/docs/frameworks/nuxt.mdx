...
2. **Serverless SSR** — Deploy SSR Nuxt applications using Lambda, S3, and CloudFront with the `Nuxt` construct
3. **Containerized SSR** — Deploy SSR Nuxt applications using ECS Fargate with the `Fargate` construct
