...
1. **Client-Side Rendering** — Deploy client-side Nuxt sites using S3 and CloudFront with the [Single Page Application](/patterns/s3-cloudfront) pattern
2. **Full Stack** — Deploy SSR Nuxt applications using ECS Fargate with the [Web Service](/docs/fargate-alb) pattern
