---
title: 'Deploy a Vite Preact SPA on AWS'
description: 'Learn how to deploy a Vite-based Preact single-page application (SPA) on AWS quickly and efficiently, using S3 and CloudFront.'
---

import { Tabs, TabItem, LinkButton } from '@astrojs/starlight/components';

You can deploy a [Vite](https://vitejs.dev/) site with [Preact.js](https://preactjs.com/) on AWS with Thunder. The server pre-rendered pages produced by the build step will be stored in an S3 bucket and served using CloudFront CDN.
