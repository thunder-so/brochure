...
1. **Single Page Application (SPA)** — Deploy client-side or static pre-rendered React Router sites using S3 and CloudFront with the [Single Page Application](/patterns/s3-cloudfront) pattern
2. **Full Stack** — Deploy SSR React Router applications using ECS Fargate with the [Web Service](/docs/fargate-alb) pattern
