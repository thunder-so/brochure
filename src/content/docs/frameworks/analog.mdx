...
1. **Static Site Generation (SSG)** — Deploy static Analog sites using S3 and CloudFront with the [Single Page Application](/patterns/s3-cloudfront) pattern
2. **Full Stack** — Deploy SSR Analog applications using ECS Fargate with the [Web Service](/docs/fargate-alb) pattern
