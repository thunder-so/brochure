...
- Upload or use the Services in relation to any Content that is not your own or that you are not lawfully entitled to use.

- Use the Services to provision, deploy, or manage any Content that is unlawful, obscene, pornographic, defamatory, or otherwise prohibited (including stolen copyrighted material).

- Use the Services solely as a remote storage server

- Sell, resell, sublicense, transfer, or distribute any part of the Services.

- Send unsolicited messages or use the Services to send unsolicited messages (also known as junk mail or spam).

- Attempt to undermine the security or integrity of CloudBits' computing systems or networks, or gain unauthorized access.


You must not access or use the Services for:

- In a manner intended to avoid incurring Fees (including creating multiple Accounts, to simulate or act as a single Account) or to circumvent usage limits or quotas; 

- To engage in cryptocurrency mining; 
...
- In a manner that breaches, or causes the breach of, Export Control Laws; or 
...
- Do not reverse engineer, create derivative works from, or commercially exploit the Services.

- Do not interfere with or disrupt the Services, or create an undue burden on the Service or connected networks.

- Do not introduce software or automated agents or scripts to produce multiple accounts or to strip or mine data from the Service.

- Do not perform any unauthorized benchmark tests or analyses relating to our Services.

- Do not impersonate others or misrepresent authorization to act on behalf of others or CloudBits.
